...
namespace GreatWall
{
    ...
    public class OrderDialog : IDialog<string>
    {
        ...
        //string strDBServer = "Server=tcp:greatwall-db-server2.database.windows.net,1433;Initial Catalog=greatwall-db;Persist Security Info=False;User ID=lkw;Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
